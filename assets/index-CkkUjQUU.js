const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./ProjectsRouter-UyQ9RieV.js","./ProjectsRouter-CJRna95Z.css"])))=>i.map(i=>d[i]);
(function polyfill() {
...
function requireReact_production() {
  ...
  function ReactElement(type, key, self, source2, owner, props) {
    self = props.ref;
    return {
      $$typeof: REACT_ELEMENT_TYPE,
      type,
  ...
  function getElementKey(element2, index) {
    return "object" === typeof element2 && null !== element2 && null != element2.key ? escape("" + element2.key) : index.toString(36);
  }
  function noop$1() {
  }
...
const component$i = "_component_kjav3_10";
const styles$t = {
  component: component$i
};
const UKButton = (props) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      className: clippy$1(styles$t.component, props.className),
...
const ContextMenuRootContext = reactExports.createContext({
...
const component$h = "_component_p0do9_10";
const button$1 = "_button_p0do9_29";
const styles$s = {
  component: component$h,
  button: button$1
};
const ContextMenuRoot = ({ children }) => {
    ...
    ContextMenuRootContext.Provider,
    {
      value: {
        createMenu: ({ x, y, width, height, items: i }) => {
          ...
          const MENU_WIDTH = ((_a = ref.current) == null ? void 0 : _a.getBoundingClientRect().width) || 200;
          const MENU_HEIGHT = ((_b = ref.current) == null ? void 0 : _b.getBoundingClientRect().height) || 200;
          let resultX = x;
          let resultY = y;
...
const component$g = "_component_psvf3_10";
const h1component = "_h1component_psvf3_17";
const h2component = "_h2component_psvf3_22";
const h3component = "_h3component_psvf3_27";
const h4component = "_h4component_psvf3_32";
const h5component = "_h5component_psvf3_37";
const h6component = "_h6component_psvf3_42";
const styles$r = {
...
const theme = "_theme_nrhjz_10";
const level0 = "_level0_nrhjz_27";
const level1 = "_level1_nrhjz_95";
const level2 = "_level2_nrhjz_157";
const level3 = "_level3_nrhjz_221";
const mobile = "_mobile_nrhjz_284";
const styles$q = {
  theme,
  level0,
  level1,
...
const LevelContext = reactExports.createContext(0);
const useLevel = () => reactExports.useContext(LevelContext);
const useLevelClass = (level) => {
  switch (level) {
    case 0:
      return styles$q.level0;
    case 1:
      return styles$q.level1;
    case 2:
      return styles$q.level2;
    case 3:
      return styles$q.level3;
    default:
      return styles$q.level0;
  }
};
const UKHeading = (props) => {
  const level = reactExports.useContext(LevelContext);
  switch (props.level || level || 1) {
    case 1:
      return /* @__PURE__ */ jsxRuntimeExports.jsx(
        "h1",
        {
          className: clippy$1(styles$r.component, styles$r.h1component, props.className),
          style: props.style,
          children: props.text
        }
      );
    case 2:
      return /* @__PURE__ */ jsxRuntimeExports.jsx(
        "h2",
        {
          className: clippy$1(styles$r.component, styles$r.h2component, props.className),
          style: props.style,
          children: props.text
        }
      );
    case 3:
      return /* @__PURE__ */ jsxRuntimeExports.jsx(
        "h3",
        {
          className: clippy$1(styles$r.component, styles$r.h3component, props.className),
          style: props.style,
          children: props.text
        }
      );
    case 4:
      return /* @__PURE__ */ jsxRuntimeExports.jsx(
        "h4",
        {
          className: clippy$1(styles$r.component, styles$r.h4component, props.className),
          style: props.style,
          children: props.text
        }
      );
    case 5:
      return /* @__PURE__ */ jsxRuntimeExports.jsx(
        "h5",
        {
          className: clippy$1(styles$r.component, styles$r.h5component, props.className),
          style: props.style,
          children: props.text
        }
      );
    case 6:
      return /* @__PURE__ */ jsxRuntimeExports.jsx(
        "h6",
        {
          className: clippy$1(styles$r.component, styles$r.h6component, props.className),
          style: props.style,
          children: props.text
        }
      );
...
const component$f = "_component_w586s_10";
const row$1 = "_row_w586s_16";
const disableMargin = "_disableMargin_w586s_22";
const column$1 = "_column_w586s_28";
const styles$p = {
...
const UKSeparator = (props) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: clippy$1(styles$p.component, styles$p[props.direction], props.disableMargin && styles$p.disableMargin, props.className) });
};
...
const IncrementLevel = (props) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(LevelContext.Provider, { value: useLevel() + 1, children: props.children });
};
const component$e = "_component_erxw3_10";
const styles$o = {
...
const UKBox = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      className: clippy$1(styles$o.component, props.className, useLevelClass(level)),
      style: props.style,
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(IncrementLevel, { children: props.children })
    }
  );
};
const component$d = "_component_173cg_10";
const clickable = "_clickable_173cg_25";
const header = "_header_173cg_52";
const actions = "_actions_173cg_59";
const content = "_content_173cg_67";
const styles$n = {
...
const DecrementLevel = (props) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(LevelContext.Provider, { value: useLevel() - 1, children: props.children });
};
const UKCard = (props) => {
  const level = props.level || useLevel();
  if (props.onClick) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(IncrementLevel, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        style: props.style,
        className: clippy$1(styles$n.component, useLevelClass(level), props.containerClassName, styles$n.clickable),
        onClick: props.onClick,
        children: [
          props.header && /* @__PURE__ */ jsxRuntimeExports.jsx(UKBox, { className: clippy$1(styles$n.header, props.headerClassName), children: props.header }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: clippy$1(styles$n.content, props.className), children: props.children }),
          props.actions && /* @__PURE__ */ jsxRuntimeExports.jsx(UKBox, { className: clippy$1(styles$n.actions, props.actionsClassName), children: props.actions })
        ]
      }
    ) }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(IncrementLevel, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    {
      style: props.style,
      className: clippy$1(styles$n.component, useLevelClass(level), props.containerClassName),
      children: [
        props.header && /* @__PURE__ */ jsxRuntimeExports.jsx(UKBox, { className: clippy$1(styles$n.header, props.headerClassName), children: props.header }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: clippy$1(styles$n.content, props.className), children: props.children }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(DecrementLevel, { children: props.actions && /* @__PURE__ */ jsxRuntimeExports.jsx(UKBox, { className: clippy$1(styles$n.actions, props.actionsClassName), children: props.actions }) })
      ]
    }
  ) }) });
};
const UKIcons = {
  Link: () => __vitePreload(() => import("./link-16-BzWwI98C.js"), true ? [] : void 0, import.meta.url),
  ServerError: () => __vitePreload(() => Promise.resolve().then(() => serverError$1), true ? void 0 : void 0, import.meta.url),
  X: () => __vitePreload(() => import("./x-16-CdMb8sfS.js"), true ? [] : void 0, import.meta.url),
  YourDashLogo: () => __vitePreload(() => import("./yourdash-DrFFgUgN.js"), true ? [] : void 0, import.meta.url)
};
const component$c = "_component_aplwx_6";
const preserveColor = "_preserveColor_aplwx_20";
const styles$m = {
  component: component$c,
  preserveColor
};
const ServerErrorIcon = "data:image/svg+xml,%3csvg%20width='16'%20height='16'%20viewBox='0%200%2016%2016'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20fill-rule='evenodd'%20clip-rule='evenodd'%20d='M4.5%2012C3.11929%2012%202%2010.8807%202%209.5C2%208.27003%202.88822%207.24752%204.05823%207.03891C4.0201%206.86534%204%206.68502%204%206.5C4%205.11929%205.11929%204%206.5%204C7.74358%204%208.77509%204.908%208.96772%206.09719C9.13314%206.03438%209.31255%206%209.5%206C10.1768%206%2010.7489%206.4482%2010.9356%207.06396C11.117%207.02212%2011.3059%207%2011.5%207C12.8807%207%2014%208.11929%2014%209.5C14%2010.8807%2012.8807%2012%2011.5%2012H4.5ZM7.56111%207.81633L7.68889%209.63946H8.31111L8.43889%207.81633V7H7.56111V7.81633ZM7.61111%2010.8966C7.68889%2010.9655%207.79074%2011%207.91667%2011H8.07778C8.20741%2011%208.30926%2010.9655%208.38333%2010.8966C8.46111%2010.8277%208.5%2010.7351%208.5%2010.619C8.5%2010.5029%208.46111%2010.4104%208.38333%2010.3415C8.30926%2010.2726%208.20926%2010.2381%208.08333%2010.2381H7.91667C7.79074%2010.2381%207.68889%2010.2726%207.61111%2010.3415C7.53704%2010.4104%207.5%2010.5029%207.5%2010.619C7.5%2010.7315%207.53704%2010.824%207.61111%2010.8966Z'%20fill='white'/%3e%3c/svg%3e";
const serverError$1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: ServerErrorIcon
}, Symbol.toStringTag, { value: "Module" }));
const UKIcon = (props) => {
  const [icon2, setIcon] = reactExports.useState(ServerErrorIcon);
  reactExports.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      className: `${styles$m.component} ${props.className} ${props.preserveColor ? styles$m.preserveColor : ""}`,
      style: {
        "--icon": `url("${icon2}")`,
...
const component$b = "_component_1g3hh_10";
const styles$l = {
  component: component$b
};
const UKIconButton = (props) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      style: props.style,
      ...
      className: clippy$1(styles$l.component, props.className),
...
const component$a = "_component_125pe_10";
const styles$k = {
  component: component$a
};
const UKText = (props) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: clippy$1(styles$k.component, props.className), children: props.text });
};
...
const container$2 = "_container_1wk2b_6";
const component$9 = "_component_1wk2b_20";
const cardContent = "_cardContent_1wk2b_34";
const success = "_success_1wk2b_42";
const error$1 = "_error_1wk2b_46";
const warning$1 = "_warning_1wk2b_50";
const info = "_info_1wk2b_54";
const heading$1 = "_heading_1wk2b_58";
const pointerEvents = "_pointerEvents_1wk2b_64";
const styles$j = {
    ...
    ToastContext.Provider,
    {
      value: {
        showToast: (data) => {
          ...
          setToasts((t) => [...t, { ...data, uuid, animatingOut: false }]);
          if (!data.persist) {
            setTimeout(() => {
              setToasts(
                (t) => t.map((toast) => {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$j.container, children: toasts.map((t) => {
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            UKCard,
            {
              actions: t.persist ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                UKIconButton,
                {
                  accessibleLabel: "Close toasts",
                  icon: UKIcons.X,
                  onClick: () => setToasts((toasts2) => toasts2.filter((x) => x.uuid !== t.uuid))
                }
              ) : null,
              className: clippy$1(styles$j.cardContent, t.type && styles$j[t.type]),
              containerClassName: clippy$1(
                styles$j.component,
                t.persist && styles$j.pointerEvents,
...
const UIKitRoot = (props) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: clippy$1(styles$q.theme, styles$q.level0, isMobileDevice() && styles$q.mobile), children: /* @__PURE__ */ jsxRuntimeExports.jsx(ContextMenuRoot, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Toasts, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(LevelContext.Provider, { value: 0, children: props.children }) }) }) });
};
var client = { exports: {} };
...
function requireReactDomClient_production() {
  ...
  function updateInput(element2, value, defaultValue, lastDefaultValue, checked, defaultChecked, type, name) {
    element2.name = "";
    ...
    null != name && "function" !== typeof name && "symbol" !== typeof name && "boolean" !== typeof name ? element2.name = "" + getToStringValue(name) : element2.removeAttribute("name");
  }
  function initInput(element2, value, defaultValue, checked, defaultChecked, type, name, isHydrating2) {
    ...
    null != name && "function" !== typeof name && "symbol" !== typeof name && "boolean" !== typeof name && (element2.name = name);
  }
  ...
  var classComponentUpdater = {
    isMounted: function(component2) {
      return (component2 = component2._reactInternals) ? getNearestMountedFiber(component2) === component2 : false;
    },
...
function createRoutesFromChildren(children, parentPath = []) {
  let routes = [];
  reactExports.Children.forEach(children, (element2, index) => {
...
function PrefetchPageLinks({
  ...
  return /* @__PURE__ */ reactExports.createElement(PrefetchPageLinksImpl, { page: page2, matches, ...dataLinkProps });
}
...
function PrefetchPageLinksImpl({
  ...
  let dataHrefs = reactExports.useMemo(() => {
    ...
    let url = singleFetchUrl(page2, basename);
...
const component$8 = "_component_eathd_10";
const row = "_row_eathd_15";
const column = "_column_eathd_19";
const centerHorizontally = "_centerHorizontally_eathd_23";
const centerVertically = "_centerVertically_eathd_27";
const padding = "_padding_eathd_31";
const styles$i = {
...
const UKFlex = (props) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      className: clippy$1(
        styles$i.component,
        styles$i[props.direction],
        props.className,
        props.centerHorizontally && styles$i.centerHorizontally,
        props.centerVertically && styles$i.centerVertically,
        props.padding && styles$i.padding
      ),
...
const view$1 = "_view_l6sy4_39";
const styles$h = {
  background,
  view: view$1
};
const UKDialog = ({ children, className, actionsClassName, headerClassName, actions: actions2, header: header2 }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$h.background, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    UKCard,
    {
      containerClassName: styles$h.view,
      actionsClassName,
      headerClassName,
      actions: actions2,
      header: header2,
...
const spinnerBack = "_spinnerBack_7t5t1_26";
const spinnerBorder = "_spinnerBorder_7t5t1_37";
const spinnerCutoutContainer = "_spinnerCutoutContainer_7t5t1_48";
const spinnerCutout = "_spinnerCutout_7t5t1_48";
const spinnerCutoutOne = "_spinnerCutoutOne_7t5t1_65";
const spinnerCutoutTwo = "_spinnerCutoutTwo_7t5t1_70";
const styles$g = {
...
const UKSpinner = (props) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      className: styles$g.component,
      style: props.style,
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: styles$g.container, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$g.spinnerBorder }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$g.spinnerBack }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$g.spinnerCutoutContainer, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: clippy$1(styles$g.spinnerCutoutOne, styles$g.spinnerCutout) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: clippy$1(styles$g.spinnerCutoutTwo, styles$g.spinnerCutout) })
        ] })
      ] })
    }
  );
...
(function(objectUtil2) {
  objectUtil2.mergeShapes = (first2, second2) => {
    return {
      ...first2,
      ...second2
...
class ZodRecord extends ZodType {
  ...
  static create(first2, second2, third2) {
    if (second2 instanceof ZodType) {
      return new ZodRecord({
        keyType: first2,
        valueType: second2,
        typeName: ZodFirstPartyTypeKind.ZodRecord,
        ...processCreateParams(third2)
      });
    }
    return new ZodRecord({
...
class ZodEnum extends ZodType {
  ...
  _parse(input2) {
    ...
    if (!__classPrivateFieldGet(this, _ZodEnum_cache).has(input2.data)) {
      const ctx = this._getOrReturnCtx(input2);
      const expectedValues = this._def.values;
      addIssueToContext(ctx, {
        received: ctx.data,
...
class ZodNativeEnum extends ZodType {
  ...
  _parse(input2) {
    ...
    if (!__classPrivateFieldGet(this, _ZodNativeEnum_cache).has(input2.data)) {
      const expectedValues = util.objectValues(nativeEnumValues);
      addIssueToContext(ctx, {
        received: ctx.data,
        code: ZodIssueCode.invalid_enum_value,
...
async function ftch(basePath, path, method, responseType, headers, body) {
  ...
  switch (responseType) {
    ...
    case "bytes":
    case "uint8":
      return { data: response.body, status: response.status, error: false, response };
  }
}
class Tunnel {
  constructor() {
    this.baseUrl = "";
    if (localStorage.getItem("instance_url") !== void 0 && localStorage.getItem("instance_url") !== "") {
      this.__internal_connectTo(localStorage.getItem("instance_url"));
    }
    return this;
  }
  __internal_connectTo(instanceUrl2) {
    this.baseUrl = instanceUrl2;
    return this;
  }
  async get(path, responseType, responseSchema) {
    return await ftch(this.baseUrl, path, "GET", responseType);
  }
  async post(path, body, responseType, responseSchema) {
    return await ftch(this.baseUrl, path, "POST", responseType, {}, JSON.stringify(body));
  }
  async put(path, body, responseType, responseSchema) {
    return await ftch(this.baseUrl, path, "PUT", responseType, {}, body);
  }
  async delete(path, responseType, responseSchema) {
    return await ftch(this.baseUrl, path, "DELETE", responseType, {});
  }
}
const tun = new Tunnel();
function toAuthImgUrl(authenticatedImageSrc) {
  return tun.baseUrl + authenticatedImageSrc;
}
const componentContainer = "_componentContainer_1d6hn_10";
const component$6 = "_component_1d6hn_10";
const noRounding = "_noRounding_1d6hn_27";
const loaded = "_loaded_1d6hn_31";
const loading = "_loading_1d6hn_44";
const serverError = "_serverError_1d6hn_52";
const styles$f = {
  componentContainer,
...
const UKImage = (props) => {
  const ref = reactExports.useRef(null);
  const [src, setSrc] = reactExports.useState(props.src);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      ref,
      onClick: props.onClick,
      className: clippy$1(styles$f.componentContainer, props.containerClassName, !loaded2 && styles$f.loading, hasFailed && styles$f.serverError),
      style: {
        // @ts-ignore
        "--background-size": backgroundSize + "px",
        ...props.style
      },
      children: !hasFailed ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
          className: clippy$1(styles$f.component, props.className, loaded2 && styles$f.loaded, props.noRounding && styles$f.noRounding),
          draggable: false,
          width: props.width,
          height: props.height,
          onError: () => {
      ...
      ) : /* @__PURE__ */ jsxRuntimeExports.jsx(UKIcon, { icon: UKIcons.ServerError })
    }
  );
};
const component$5 = "_component_1drme_10";
const styles$e = {
  component: component$5
};
const UKSubtext = (props) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: clippy$1(styles$e.component, props.className), children: props.text });
};
const component$4 = "_component_10l5e_10";
const icon = "_icon_10l5e_28";
const input = "_input_10l5e_36";
const noIcon = "_noIcon_10l5e_44";
const styles$d = {
...
const UKTextInput = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: clippy$1(styles$d.component, props.className), children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
        ...
        className: clippy$1(styles$d.input, !props.icon && styles$d.noIcon),
...
const page$2 = "_page_xqg0i_10";
const metadataCardContainer = "_metadataCardContainer_xqg0i_23";
const formCard = "_formCard_xqg0i_28";
const button = "_button_xqg0i_35";
const avatar = "_avatar_xqg0i_38";
const instanceUrl = "_instanceUrl_xqg0i_43";
const metadataCard = "_metadataCard_xqg0i_23";
const backgroundImageContainer = "_backgroundImageContainer_xqg0i_55";
const backgroundImage = "_backgroundImage_xqg0i_55";
const metadata = "_metadata_xqg0i_23";
const title$1 = "_title_xqg0i_79";
const message$1 = "_message_xqg0i_83";
const styles$c = {
  page: page$2,
...
function loginUser(username, password) {
  return new Promise(async (resolve, reject) => {
    const req = await tun.post(`/login/user/authenticate`, {
      username,
      password
    }, "json", z.object({
      sessionId: z.string(),
...
const IndexCardsPage = (props) => {
  var _a, _b;
  const $ = compilerRuntimeExports.c(43);
  ...
  const [user, setUser] = reactExports.useState(t0);
  let t1;
  let t2;
  if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
    t1 = () => {
      if (localStorage.getItem("current_user_username") || false) {
  ...
  if ($[6] === Symbol.for("react.memo_cache_sentinel")) {
    t5 = clippy(styles$c.formCard);
    $[6] = t5;
  } else {
    t5 = $[6];
  }
  let t6;
  if ($[7] !== user.avatar || $[8] !== user.fullName || $[9] !== user.isValid) {
    t6 = user.isValid ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(UKImage, { className: styles$c.avatar, src: toAuthImgUrl(user.avatar), accessibleLabel: "Your Avatar" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(UKHeading, { level: 2, text: `${user.fullName.first} ${user.fullName.last}` })
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx(UKHeading, { level: 3, text: "Login" });
    $[7] = user.avatar;
    $[8] = user.fullName;
    $[9] = user.isValid;
    $[10] = t6;
  ...
  if ($[12] === Symbol.for("react.memo_cache_sentinel")) {
    t8 = /* @__PURE__ */ jsxRuntimeExports.jsx(UKTextInput, { accessibleName: "Username", placeholder: "Username", type: "username", defaultValue: localStorage.getItem("current_user_username") || "", getValue: setUsername, autoComplete: `yourdash-instance-login username instance-${tun.baseUrl}` });
    $[12] = t8;
  } else {
    t8 = $[12];
  }
  let t9;
  if ($[13] !== navigate || $[14] !== password || $[15] !== user.isValid || $[16] !== username) {
    t9 = /* @__PURE__ */ jsxRuntimeExports.jsx(UKTextInput, { accessibleName: "Password", placeholder: "Password", type: "password", getValue: setPassword, autoComplete: `yourdash-instance-login password instance-${tun.baseUrl}`, onSubmit: () => {
  ...
  if ($[18] === Symbol.for("react.memo_cache_sentinel")) {
    t10 = /* @__PURE__ */ jsxRuntimeExports.jsx(UKSeparator, { direction: "column" });
    $[18] = t10;
  } else {
    t10 = $[18];
  }
  const t11 = username === "" || password === "" || !user.isValid;
  let t12;
  if ($[19] !== navigate || $[20] !== password || $[21] !== toast || $[22] !== username) {
    t12 = () => {
      loginUser(username, password).then(() => {
        navigate("/login/success");
      }).catch(() => {
  ...
  let t13;
  if ($[24] !== t11 || $[25] !== t12) {
    t13 = /* @__PURE__ */ jsxRuntimeExports.jsx(UKButton, { className: styles$c.button, text: "Login", disabled: t11, onClick: t12 });
    $[24] = t11;
    $[25] = t12;
    $[26] = t13;
  } else {
  ...
  if ($[27] === Symbol.for("react.memo_cache_sentinel")) {
    t14 = /* @__PURE__ */ jsxRuntimeExports.jsx(UKSubtext, { className: styles$c.instanceUrl, text: tun.baseUrl });
    $[27] = t14;
  } else {
    t14 = $[27];
  }
  let t15;
  if ($[28] !== t13 || $[29] !== t6 || $[30] !== t9) {
    t15 = /* @__PURE__ */ jsxRuntimeExports.jsxs(UKCard, { className: t5, children: [
      t6,
      t7,
      t8,
      t9,
  ...
  if ($[32] === Symbol.for("react.memo_cache_sentinel")) {
    t16 = /* @__PURE__ */ jsxRuntimeExports.jsx(UKImage, { containerClassName: styles$c.backgroundImageContainer, className: styles$c.backgroundImage, src: toAuthImgUrl("/login/instance/background"), accessibleLabel: "" });
    $[32] = t16;
  } else {
    t16 = $[32];
  }
  const t17 = ((_a = props.metadata) == null ? void 0 : _a.title) || "Unknown instance title";
  let t18;
  if ($[33] !== t17) {
    t18 = /* @__PURE__ */ jsxRuntimeExports.jsx(UKHeading, { level: 1, text: t17, className: styles$c.title });
    $[33] = t17;
    $[34] = t18;
  } else {
    t18 = $[34];
  ...
  let t19;
  if ($[35] !== props.metadata) {
    t19 = ((_b = props.metadata) == null ? void 0 : _b.message) && /* @__PURE__ */ jsxRuntimeExports.jsx(UKSubtext, { className: styles$c.message, text: props.metadata.message });
    $[35] = props.metadata;
    $[36] = t19;
  } else {
    t19 = $[36];
  ...
  let t20;
  if ($[37] !== t18 || $[38] !== t19) {
    t20 = /* @__PURE__ */ jsxRuntimeExports.jsxs(UKCard, { className: styles$c.metadataCard, containerClassName: styles$c.metadataCardContainer, children: [
      t16,
      /* @__PURE__ */ jsxRuntimeExports.jsxs(UKFlex, { direction: "column", className: styles$c.metadata, children: [
        t18,
        t19
      ] })
    ] });
  ...
  let t21;
  if ($[40] !== t15 || $[41] !== t20) {
    t21 = /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$c.page, children: [
      t15,
      t20
    ] });
    $[40] = t15;
...
const spinner = "_spinner_1769o_6";
const styles$b = {
  spinner
};
function useResource(resource, options) {
  ...
  reactExports.useEffect(() => {
    ...
    resource().then((d) => {
      ...
      const transformFunction = (options == null ? void 0 : options.transform) ?? ((data2) => data2);
...
const LoginIndexPage = () => {
  ...
  const instanceMetadata = useResource(_temp$3, t0);
  let t1;
  if ($[1] !== instanceMetadata) {
    t1 = () => {
      switch (instanceMetadata == null ? void 0 : instanceMetadata.loginLayout) {
        ...
        default: {
          return /* @__PURE__ */ jsxRuntimeExports.jsx(UKFlex, { centerHorizontally: true, centerVertically: true, padding: true, direction: "column", children: /* @__PURE__ */ jsxRuntimeExports.jsx(UKHeading, { text: "Awaiting instance response..." }) });
        }
      }
    };
    $[1] = instanceMetadata;
  ...
  const SelectedLayout = t1;
  let t2;
  if ($[3] === Symbol.for("react.memo_cache_sentinel")) {
    t2 = /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$b.spinner, children: /* @__PURE__ */ jsxRuntimeExports.jsx(UKSpinner, {}) });
    $[3] = t2;
  } else {
    t2 = $[3];
  }
  let t3;
  if ($[4] !== SelectedLayout) {
    t3 = /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: t2, children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectedLayout, {}) }) });
    $[4] = SelectedLayout;
    $[5] = t3;
  } else {
    t3 = $[5];
...
function _temp$3() {
  return tun.get("/login/instance/metadata", "json", z.object({
    title: z.string(),
    message: z.string(),
...
function isValidInstance(instanceUrl2) {
  const instanceUrlWithoutProtocol = instanceUrl2 == null ? void 0 : instanceUrl2.split("://")[1];
  const doesContainPort = (instanceUrlWithoutProtocol == null ? void 0 : instanceUrlWithoutProtocol.split(":")[1]) !== void 0;
  return new Promise(async (resolve) => {
    if (instanceUrl2 === "") {
      return resolve(false);
    }
    if (!(instanceUrl2.startsWith("http://") || instanceUrl2.startsWith("https://"))) {
      return resolve(false);
    }
    fetch(`${instanceUrl2}${doesContainPort ? "" : ":3563"}/test`).then((response) => {
      if (response.ok) return response.json();
      resolve(false);
    }).then((jsonResponse) => {
      if (jsonResponse.type === "YourDash" && jsonResponse.status === 1) {
        resolve(true);
        return;
      }
      resolve(false);
...
const dialogHeading = "_dialogHeading_15lf5_6";
const styles$a = {
  dialogHeading
};
const LoginIndexPagePreload = () => {
  const $ = compilerRuntimeExports.c(8);
  const navigate = useNavigate();
  const [validInstance, setValidInstance] = reactExports.useState(void 0);
  const [retryCounter, setRetryCounter] = reactExports.useState(0);
  let t0;
  if ($[0] !== navigate) {
    t0 = () => {
      isValidInstance(localStorage.getItem("instance_url") || "").then((isValid2) => {
        setValidInstance(isValid2);
        if (!isValid2) {
  ...
  let t2;
  if ($[4] !== navigate || $[5] !== retryCounter || $[6] !== validInstance) {
    t2 = /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: validInstance === void 0 || !validInstance ? /* @__PURE__ */ jsxRuntimeExports.jsx(UKDialog, { header: [/* @__PURE__ */ jsxRuntimeExports.jsx(UKHeading, { className: styles$a.dialogHeading, text: "Logging in..." }, "Heading")], actions: [/* @__PURE__ */ jsxRuntimeExports.jsxs(UKFlex, { direction: "row", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(UKButton, { text: "Retry", onClick: () => {
        setRetryCounter(retryCounter + 1);
      } }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(UKButton, { text: "Select new instance", onClick: () => {
        navigate("/login/instance");
      } })
    ] }, "flex")], children: /* @__PURE__ */ jsxRuntimeExports.jsx(UKText, { text: "Checking if the instance is valid and online" }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoginIndexPage, {}) }) });
    $[4] = navigate;
    $[5] = retryCounter;
    $[6] = validInstance;
    $[7] = t2;
...
const component$3 = "_component_7iu6s_10";
const styles$9 = {
...
const UKLink = (props) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    {
      href: props.to,
      className: clippy$1(styles$9.component, props.className),
      children: [
        props.text,
        !props.hideLinkIcon && /* @__PURE__ */ jsxRuntimeExports.jsx(
          UKIcon,
          {
            icon: UKIcons.Link,
...
const component$2 = "_component_1y11j_10";
const styles$8 = {
  component: component$2
};
const UKTextButton = (props) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      className: clippy$1(styles$8.component, props.className),
      onClick: props.onClick,
      "aria-label": props.text,
      children: props.text
    }
...
const Navigation = (t0) => {
  ...
  let t2;
  if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
    t1 = /* @__PURE__ */ jsxRuntimeExports.jsx(UKImage, { src: "/assets/branding/yourdash.svg", accessibleLabel: "YourDash Logo", className: styles$7.logo });
    t2 = /* @__PURE__ */ jsxRuntimeExports.jsx(UKHeading, { level: 2, className: styles$7.title, text: "YourDash" });
    $[0] = t1;
    $[1] = t2;
  } else {
    t1 = $[0];
  ...
  const t3 = subtitle2 ? `/ ${subtitle2}` : "";
  let t4;
  if ($[2] !== t3) {
    t4 = /* @__PURE__ */ jsxRuntimeExports.jsx(UKHeading, { level: 2, className: styles$7.subtitle, text: t3 });
    $[2] = t3;
    $[3] = t4;
  } else {
    t4 = $[3];
  ...
  let t5;
  if ($[4] !== navigate) {
    t5 = /* @__PURE__ */ jsxRuntimeExports.jsx(UKTextButton, { className: styles$7.link, text: "Home", onClick: () => {
      navigate("/");
    } });
    $[4] = navigate;
    $[5] = t5;
  ...
  let t6;
  if ($[6] === Symbol.for("react.memo_cache_sentinel")) {
    t6 = /* @__PURE__ */ jsxRuntimeExports.jsx(UKTextButton, { className: styles$7.link, text: "Docs", onClick: _temp$2 });
    $[6] = t6;
  } else {
    t6 = $[6];
  }
  ...
  if ($[7] === Symbol.for("react.memo_cache_sentinel")) {
    t7 = /* @__PURE__ */ jsxRuntimeExports.jsx(UKTextButton, { className: clippy(styles$7.link, styles$7.source), text: "Source", onClick: _temp2$1 });
    $[7] = t7;
  } else {
    t7 = $[7];
  }
  let t8;
  if ($[8] !== navigate) {
    t8 = /* @__PURE__ */ jsxRuntimeExports.jsx(UKTextButton, { className: styles$7.link, text: "Login", onClick: () => {
      navigate("/login");
    } });
    $[8] = navigate;
    $[9] = t8;
  ...
  let t9;
  if ($[10] !== t4 || $[11] !== t5 || $[12] !== t8) {
    t9 = /* @__PURE__ */ jsxRuntimeExports.jsxs(UKBox, { className: styles$7.navigationBar, children: [
      t1,
      t2,
      t4,
      t5,
  ...
  if ($[14] === Symbol.for("react.memo_cache_sentinel")) {
    t10 = /* @__PURE__ */ jsxRuntimeExports.jsxs(UKBox, { level: 1, className: styles$7.notice, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(UKText, { text: "YourDash is a pre-alpha project. " }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(UKLink, { hideLinkIcon: true, to: "/docs/pre-alpha", text: "learn more." })
    ] });
    t11 = /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {});
    $[14] = t10;
    $[15] = t11;
  } else {
    t10 = $[14];
  ...
  if ($[19] === Symbol.for("react.memo_cache_sentinel")) {
    t15 = /* @__PURE__ */ jsxRuntimeExports.jsx(UKLink, { className: styles$7.link, hideLinkIcon: true, text: "a530c5d3f1f34701ba1c7c18379d1fd6f256af86", to: `https://github.com/yourdash/yourdash/tree/${"a530c5d3f1f34701ba1c7c18379d1fd6f256af86"}` });
...
const page$1 = "_page_qu5sa_6";
const error = "_error_qu5sa_14";
const styles$6 = {
  page: page$1,
  error
};
const ErrorElement = () => {
  var _a;
  const $ = compilerRuntimeExports.c(8);
  const error2 = ((_a = useRouteError()) == null ? void 0 : _a.error) || {};
  let t0;
  if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
    t0 = /* @__PURE__ */ jsxRuntimeExports.jsx(UKHeading, { level: 1, text: "An error has occurred" });
    $[0] = t0;
  } else {
    t0 = $[0];
  }
  let t1;
  if ($[1] !== error2.message) {
    t1 = error2.message && /* @__PURE__ */ jsxRuntimeExports.jsx(UKHeading, { level: 3, text: error2.message });
    $[1] = error2.message;
    $[2] = t1;
  } else {
    t1 = $[2];
  ...
  let t2;
  if ($[3] !== error2.stack) {
    t2 = error2.stack && /* @__PURE__ */ jsxRuntimeExports.jsx(UKText, { text: error2.stack });
    $[3] = error2.stack;
    $[4] = t2;
  } else {
    t2 = $[4];
  ...
  let t3;
  if ($[5] !== t1 || $[6] !== t2) {
    t3 = /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$6.page, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(UKCard, { containerClassName: styles$6.error, children: [
      t0,
      t1,
      t2
    ] }) });
...
const KeyPointsCard = (t0) => {
  ...
  let t1;
  if ($[0] !== action.label || $[1] !== action.onClick) {
    t1 = /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(UKButton, { onClick: action.onClick, text: action.label }) });
    $[0] = action.label;
    $[1] = action.onClick;
    $[2] = t1;
  } else {
  ...
  let t2;
  if ($[3] !== title2) {
    t2 = /* @__PURE__ */ jsxRuntimeExports.jsx(UKHeading, { level: 2, text: title2, className: "!text-4xl font-semibold !text-start pt-4" });
    $[3] = title2;
    $[4] = t2;
  } else {
    t2 = $[4];
  ...
  let t3;
  if ($[5] !== content2) {
    t3 = /* @__PURE__ */ jsxRuntimeExports.jsx(UKText, { className: "text-start", text: content2 });
    $[5] = content2;
    $[6] = t3;
  } else {
    t3 = $[6];
  ...
  let t4;
  if ($[7] !== t1 || $[8] !== t2 || $[9] !== t3) {
    t4 = /* @__PURE__ */ jsxRuntimeExports.jsxs(UKCard, { actions: t1, children: [
      t2,
      t3
    ] });
    $[7] = t1;
...
const component$1 = "_component_gvwt1_10";
const styles$5 = {
  component: component$1
};
const UKButtonLink = (props) => {
  const navigate = useNavigate();
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    UKButton,
    {
      ...
      text: props.text,
      className: clippy$1(styles$5.component, props.className)
    }
  );
};
const floatContainer = "_floatContainer_1hevs_6";
const floatingApplication = "_floatingApplication_1hevs_6";
const first = "_first_1hevs_9";
const second = "_second_1hevs_12";
const third = "_third_1hevs_15";
const fourth = "_fourth_1hevs_18";
const container = "_container_1hevs_35";
const styles$4 = {
  floatContainer,
  floatingApplication,
  first,
...
const FloatingApplication = (t0) => {
  ...
  let t1;
  if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
    t1 = clippy(styles$4.container);
    $[0] = t1;
  } else {
    t1 = $[0];
  }
  const t2 = position === 0 ? styles$4.first : position === 1 ? styles$4.second : position === 2 ? styles$4.third : styles$4.fourth;
  let t3;
  if ($[1] !== t2) {
    t3 = clippy("animate__animated animate__pulse animate__infinite", styles$4.floatContainer, t2);
    $[1] = t2;
    $[2] = t3;
  } else {
    t3 = $[2];
  ...
  let t4;
  if ($[3] === Symbol.for("react.memo_cache_sentinel")) {
    t4 = clippy(styles$4.floatingApplication);
    $[3] = t4;
  } else {
    t4 = $[3];
  }
  let t5;
  if ($[4] !== src) {
    t5 = /* @__PURE__ */ jsxRuntimeExports.jsx("img", { className: t4, src, alt: "", draggable: false });
    $[4] = src;
    $[5] = t5;
  } else {
    t5 = $[5];
  ...
  let t6;
  if ($[6] !== t3 || $[7] !== t5) {
    t6 = /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: t1, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: t3, children: t5 }) });
    $[6] = t3;
    $[7] = t5;
    $[8] = t6;
  } else {
...
const IndexPageHeroApplications = () => {
  const $ = compilerRuntimeExports.c(1);
  let t0;
  if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
    t0 = /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: clippy("relative lg:flex hidden animate__animated animate__bounceInDown animate__500ms animate__duration_2000ms h-full invisible lg:visible"), children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(FloatingApplication, { src: "/assets/promo-apps/files.png", position: 0 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(FloatingApplication, { src: "/assets/promo-apps/organisation.png", position: 1 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(FloatingApplication, { src: "/assets/promo-apps/code_studio.png", position: 2 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(FloatingApplication, { src: "/assets/promo-apps/store.png", position: 3 })
    ] });
    $[0] = t0;
  } else {
    t0 = $[0];
...
const IndexPageHeroTaglines = () => {
  ...
  reactExports.useEffect(t0, t1);
  const t2 = taglineIndex === 0 ? 0 : "-100%";
  const t3 = taglineIndex === 0 ? 1 : 0;
  const t4 = taglineIndex === 0 ? "100%" : "0%";
  let t5;
  if ($[3] !== t2 || $[4] !== t3 || $[5] !== t4) {
    t5 = /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute flex items-end text-end transition-all motion-reduce:transition-none duration-500", style: {
      right: t2,
      opacity: t3,
      scale: t4
  ...
  const t6 = taglineIndex === 1 ? 0 : "-100%";
  const t7 = taglineIndex === 1 ? 1 : 0;
  const t8 = taglineIndex === 1 ? "100%" : "0%";
  let t9;
  if ($[7] !== t6 || $[8] !== t7 || $[9] !== t8) {
    t9 = /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute flex items-end text-end transition-all motion-reduce:transition-none duration-500", style: {
      right: t6,
      opacity: t7,
      scale: t8
    }, children: "Collaborate seamlessly" });
    $[7] = t6;
    $[8] = t7;
    $[9] = t8;
    $[10] = t9;
  ...
  const t10 = taglineIndex === 2 ? 0 : "-100%";
  const t11 = taglineIndex === 2 ? 1 : 0;
  const t12 = taglineIndex === 2 ? "100%" : "0%";
  let t13;
  if ($[11] !== t10 || $[12] !== t11 || $[13] !== t12) {
    t13 = /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute flex items-end text-end transition-all motion-reduce:transition-none duration-500", style: {
      right: t10,
      opacity: t11,
      scale: t12
    }, children: "Make it your own" });
    $[11] = t10;
    $[12] = t11;
    $[13] = t12;
    $[14] = t13;
  ...
  let t14;
  if ($[15] !== t13 || $[16] !== t5 || $[17] !== t9) {
    t14 = /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative whitespace-nowrap w-full animate__animated animate__slideInRight animate__500ms", children: [
      t5,
      t9,
      t13
    ] });
...
const component = "_component_2zqco_6";
const brandName = "_brandName_2zqco_11";
const styles$3 = {
  component,
  brandName
};
const IndexPageHero = () => {
  ...
  let t0;
  if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
    t0 = clippy("animate__animated animate__fadeIn w-full h-[30rem] overflow-hidden relative [clip-path:_polygon(0_0,_100%_0%,_100%_85%,_0%_100%);] grid lg:grid-cols-2 grid-cols-1 grid-rows-1 gap-10 pb-4 drop-shadow-xl", styles$3.component);
    $[0] = t0;
  } else {
    t0 = $[0];
  }
  ...
  let t2;
  if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
    t1 = /* @__PURE__ */ jsxRuntimeExports.jsx(UKHeading, { level: 1, className: clippy("animate__jackInTheBox animate__animated animate__250ms", styles$3.brandName), text: "YourDash" });
    t2 = /* @__PURE__ */ jsxRuntimeExports.jsx(IndexPageHeroTaglines, {});
    $[1] = t1;
    $[2] = t2;
  } else {
    t1 = $[1];
  ...
  let t3;
  if ($[3] === Symbol.for("react.memo_cache_sentinel")) {
    t3 = /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: t0, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-end justify-center overflow-hidden lg:ml-0 lg:mr-0 ml-auto mr-auto", children: [
        t1,
        t2,
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 pt-7 justify-end animate__animated animate__fadeIn animate__750ms", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(UKButtonLink, { to: "/login", text: "Login" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(UKButtonLink, { to: "/login/signup", text: "Signup" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(IndexPageHeroApplications, {})
    ] });
    $[3] = t3;
  } else {
    t3 = $[3];
...
const Index = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(IndexPageHero, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "max-w-5xl mx-auto px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "lg:flex-row flex-col pt-4 flex lg:items-center lg:justify-between gap-12 w-full mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-4xl font-bold text-center lg:text-left mb-8 lg:mb-0 animate__animated animate__fadeInLeft animate__500ms animate__slow", children: [
        "Your Space, Your Rules:",
        /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
        "Host Your Own YourDash"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 flex-col animate__animated animate__fadeInRight animate__500ms animate__slow relative", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "lg:w-72 lg:text-right text-center", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base font-thin text-gray-300", children: "*" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(UKButton, { text: "Explore Documentation & Get Started", onClick: () => {
          navigate("/docs/faq");
        } }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-gray-400 absolute top-full mt-2 flex gap-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base font-thin text-gray-300 align-top", children: "*" }),
          " Optimal performance is best experienced on modern browsers and devices."
        ] })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "w-full p-4 pt-0 pb-0 gap-2 xl:grid-cols-3 lg:grid-cols-2 grid-cols-1 grid mb-4 max-w-6xl ml-auto mr-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(KeyPointsCard, { title: "Unleash Your Creativity", content: "Customize YourDash to perfectly align with your needs. Leverage downloadable themes and plugins, or even develop your own, to craft a truly unique, personalized experience.", action: {
        label: "Discover Customization Options",
        onClick() {
          navigate("/docs/faq");
        }
      } }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(KeyPointsCard, { title: "Open Source and Community Driven", content: "Transparency and collaboration are at our core. YourDash is fully open source, encouraging community contributions and providing complete visibility into the project's development.", action: {
        label: "Explore the Source Code",
        onClick() {
          window.location.href = "https://github.com/yourdash/yourdash";
        }
      } }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(KeyPointsCard, { title: "Part of a Growing Ecosystem", content: "YourDash is more than just a dashboard; it's a component within a larger ecosystem of projects.  Explore the YourDash universe to discover complementary tools and integrations.", action: {
...
const SignupPage = () => {
  ...
  let t1;
  if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
    t0 = /* @__PURE__ */ jsxRuntimeExports.jsx(UKHeading, { level: 1, text: "Signup with a YourDash Instance" });
  ...
  if ($[2] === Symbol.for("react.memo_cache_sentinel")) {
    t2 = /* @__PURE__ */ jsxRuntimeExports.jsxs(UKFlex, { direction: "column", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(UKHeading, { level: 2, text: "Signup with a public instance" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(UKButton, { text: "Signup", onClick: _temp$1 })
    ] });
    t3 = /* @__PURE__ */ jsxRuntimeExports.jsx(UKSeparator, { direction: "row", disableMargin: true });
    $[2] = t2;
    $[3] = t3;
  } else {
    t2 = $[2];
  ...
  if ($[4] === Symbol.for("react.memo_cache_sentinel")) {
    t4 = /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      t0,
      t1,
      /* @__PURE__ */ jsxRuntimeExports.jsxs(UKFlex, { direction: "row", centerHorizontally: true, children: [
        t2,
        t3,
        /* @__PURE__ */ jsxRuntimeExports.jsxs(UKFlex, { direction: "column", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(UKHeading, { level: 2, text: "Signup with a private instance" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(UKButton, { text: "Signup", onClick: _temp2 })
        ] })
      ] })
    ] });
    $[4] = t4;
...
const UKRedirect = (props) => {
  const navigate = useNavigate();
  if (props.to !== null) navigate(props.to);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(UKCard, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(UKText, { text: `Redirecting to ${props.to}` }) });
};
const page = "_page_1e5r9_10";
const notice = "_notice_1e5r9_20";
const message = "_message_1e5r9_27";
const author = "_author_1e5r9_32";
const noticeHeader = "_noticeHeader_1e5r9_38";
const heading = "_heading_1e5r9_45";
const styles$2 = {
  page,
  notice,
  message,
...
const LoginSuccessPage = () => {
  ...
  const notice2 = useResource(_temp, t0);
  let t1;
  if ($[1] !== navigate || $[2] !== notice2) {
    t1 = /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$2.page, children: notice2 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(UKCard, { containerClassName: styles$2.notice, headerClassName: styles$2.noticeHeader, actions: /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(UKButton, { onClick: () => {
      navigate("/app");
    }, text: "Continue" }) }), header: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(UKHeading, { className: styles$2.heading, level: 1, text: "Notice" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(UKSubtext, { text: "authored: " + new Date(notice2.timestamp || 0).toLocaleDateString() })
    ] }), children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(UKText, { className: styles$2.message, text: (notice2 == null ? void 0 : notice2.message) || "No message..." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(UKSubtext, { className: styles$2.author, text: `- ${(notice2 == null ? void 0 : notice2.author) || "Unknown author"}` })
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: (notice2 == null ? void 0 : notice2.display) === false && /* @__PURE__ */ jsxRuntimeExports.jsx(UKRedirect, { to: "/app" }) }) });
    $[1] = navigate;
    $[2] = notice2;
    $[3] = t1;
  } else {
...
function _temp() {
  return tun.get("/core/login/notice", "json", z.object({
    author: z.string(),
    message: z.string(),
    timestamp: z.number(),
    display: z.boolean()
...
const NotFoundPage = () => {
  ...
  let t0;
  if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
    t0 = /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center flex items-center justify-center flex-col h-max pt-20 pb-20 pr-10 pl-10 animate__animated animate__fadeIn", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(UKHeading, { className: "!text-7xl pb-4 animate__animated animate__jackInTheBox", level: 1, text: "404" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(UKSeparator, { direction: "column" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(UKSubtext, { className: "animate__animated animate__fadeInUp", text: "This page could not be found!" })
    ] });
    $[0] = t0;
  } else {
    t0 = $[0];
...
const view = "_view_1557p_10";
const styles$1 = {
  view
};
const UKPageHeader = ({ backgroundImage: backgroundImage2, heading: heading2 }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      className: styles$1.view,
      style: backgroundImage2 ? { backgroundImage: backgroundImage2 } : { backgroundImage: "linear-gradient(-45deg, #ff8093aa, #ffd264aa)" },
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        UKHeading,
        {
          level: 1,
...
const projectsGrid = "_projectsGrid_1vz7k_10";
const styles = {
  projectsGrid
};
const PROJECTS = [{
...
const ProjectsIndexPage = () => {
  ...
  let t0;
  if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
    t0 = /* @__PURE__ */ jsxRuntimeExports.jsx(UKPageHeader, { heading: "Projects" });
    $[0] = t0;
  } else {
    t0 = $[0];
  }
  let t1;
  if ($[1] !== navigate) {
    t1 = PROJECTS.map((project) => /* @__PURE__ */ jsxRuntimeExports.jsxs(UKCard, { className: "flex items-center justify-center flex-col gap-2", onClick: () => navigate(project.link), children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(UKImage, { className: "h-24 aspect-square", src: project.icon, accessibleLabel: "" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(UKHeading, { level: 2, className: "font-semibold text-3xl", text: project.name }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(UKText, { text: project.description })
    ] }));
    $[1] = navigate;
    $[2] = t1;
  } else {
  ...
  let t2;
  if ($[3] !== t1) {
    t2 = /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      t0,
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles.projectsGrid, children: t1 })
    ] });
    $[3] = t1;
    $[4] = t2;
  } else {
...
const WebsocketToasts = () => {
  ...
  let t0;
  if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
    t0 = /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, {});
    $[0] = t0;
  } else {
    t0 = $[0];
  }
...
var lazy$2 = lazy;
lazy$2.lib = lazy$1;
const ProjectsRouter = loadable$2(() => __vitePreload(() => import("./ProjectsRouter-UyQ9RieV.js"), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url));
...
root.render(/* @__PURE__ */ jsxRuntimeExports.jsxs(UIKitRoot, { children: [
  /* @__PURE__ */ jsxRuntimeExports.jsx(WebsocketToasts, {}),
  /* @__PURE__ */ jsxRuntimeExports.jsx(BrowserRouter, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Routes, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Route, { errorElement: /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorElement, {}), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Route, { element: /* @__PURE__ */ jsxRuntimeExports.jsx(Navigation, {}), children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { index: true, element: /* @__PURE__ */ jsxRuntimeExports.jsx(Index, {}) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Route, { path: "login", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { element: /* @__PURE__ */ jsxRuntimeExports.jsx(Navigation, { subtitle: "Instance" }), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "signup", element: /* @__PURE__ */ jsxRuntimeExports.jsx(SignupPage, {}) }) })
    ] })
  ] }) }) })
] }));
export {
...
//# sourceMappingURL=index-CkkUjQUU.js.map
